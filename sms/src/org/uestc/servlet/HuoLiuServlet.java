...
public class HuoLiuServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (m.equals("supplierInfo")) {
			...
			// req.getRequestDispatcher("/pages/huoliu/addsupplier2.jsp").forward(req,
			// resp);
			...
			this.shangchuan(req, resp);
			// req.getRequestDispatcher("/pages/huoliu/add.jsp").forward(req,
			// resp);
	...
	private int getTotalSize9(String s_id, String start, String end) {
		...
		String sql = "SELECT count(t2.sa_id) FROM goods t1,sale t2, supplier t3 WHERE t1.su_name=t3.su_name"
				...
				+ " t3.s_id=? and CAST(t2.sa_date AS signed)>? and" + " CAST(t2.sa_date AS signed) < ?";
	...
	private void add1(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String arr[] = new String[] { g_name, g_barcode, g_stock_num, su_name, "1", g_pur_price, g_id, g_unit, c_name };
		ArrayList list = new ArrayList();
	...
	private void addsupplier2(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		huoliu.addsupplier(s_id, s_name, su_name, su_phone, su_email, su_contacter, s_del, su_ps_return, su_gd_return,
				su_number, su_empower, su_address, su_info);
	 ...
	 * TODO Auto-generated method stub String danshu=req.getParameter("danshu");
	 * String numOfGoods=req.getParameter("numOfGoods"); String
	 * price=req.getParameter("price"); String
	 * supplier=req.getParameter("supplier");
	 * List<Object[]>list=huoliu.qrjs(supplier); Number num1 = (Number)
	 * list.get(0)[0];
	 * 
	 * Number num2 = (Number) list.get(0)[1]; req.setAttribute("danshu",
	 * danshu); req.setAttribute("numOfGoods", numOfGoods);
	 * req.setAttribute("price", price); req.setAttribute("su_gd_return",
	 * String.valueOf(num1)); req.setAttribute("su_ps_return",
	 * String.valueOf(num2));
	 * 
	 * }
	 */
	...
	private void add(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		String g_unit = req.getParameter("g_unit");
		String c_name = req.getParameter("c_name");
		String arr[] = new String[] { g_name, g_barcode, g_stock_num, su_name, "1", g_pur_price, g_unit, c_name };
		ArrayList list = new ArrayList();
		...
		try {
			...
			upload.setProgressListener(new ProgressListener() {
				public void update(long pBytesRead, long pContentLength, int arg2) {
					//("文件大小为：" + pContentLength + ",当前已处理：" + pBytesRead);
					/**
			...
			PrintWriter out = resp.getWriter();
			out.print(message);
			// req.getRequestDispatcher("/pages/goods/goodsinfo/success.jsp").forward(req,
			// resp);
			return;
	...
	private void editSupplier2(HttpServletRequest req, HttpServletResponse resp) {
		...
		String su_address = req.getParameter("su_address");
		String su_info = req.getParameter("su_info");
		huoliu.editSupplier(su_id, su_name, su_phone, su_email, su_contacter, s_del, su_ps_return, su_gd_return,
				su_empower, su_address, su_info);
