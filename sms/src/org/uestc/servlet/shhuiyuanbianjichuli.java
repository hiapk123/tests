...
public class shhuiyuanbianjichuli extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 开始进行页面的查询
		String klox = "UPDATE vip SET v_status=" + sh_zhuangtai + ",v_card_no=" + "'" + sh_bianhao + "'" + ",vip_name="
				+ "'" + sh_xingming + "'" + ",v_level=" + "'" + sh_dengji + "'" + ",vip_dsicount=" + "'" + sh_zhekou
				+ "'" + ",v_balance=" + "'" + sh_yue + "'" + ",v_commodity_integral=" + "'" + sh_jifen + "'"
				+ ",vip_tel=" + "'" + sh_tel + "'" + ",vip_pwd=" + "'" + sh_mima + "'" + ",v_birthday=" + "'"
				+ sh_shengri + "'" + ",vip_startdate=" + "'" + sh_kaikariqi + "'" + ",vip_enddate=" + "'"
				+ sh_daoqishijian + "'" + ",v_memqq=" + "'" + sh_qq + "'" + ",v_youxiang=" + "'" + sh_youxiang + "'"
