...
public class shwriteintoexcel extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// String ssl="select
		// a.v_id,a.v_card_no,a.vip_name,a.vip_tel,a.v_level,a.v_balance,a.v_commodityintegral,b.s_name,a.vip_startdate,
		// a.v_status FROM vip a LEFT JOIN store b ON a.s_id=b.s_id ";
