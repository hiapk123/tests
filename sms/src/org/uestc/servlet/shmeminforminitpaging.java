 ...
 */
@WebServlet(urlPatterns="/shmeminforminitpaging",
			name="shmeminforminitpagingServlet")
public class shmeminforminitpaging extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ksql="select a.v_id,a.v_card_no,a.vip_name,a.vip_tel,a.v_level,a.v_balance,a.v_commodity_integral,b.s_name,a.vip_startdate, a.v_status FROM vip a LEFT JOIN store b ON a.s_id=b.s_id limit "+currenys+",10";
