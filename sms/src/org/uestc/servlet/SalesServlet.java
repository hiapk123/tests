...
public class SalesServlet extends HttpServlet {
	...
	private SalesService sale = new SalesServiceImp();// 服务类
	...
	private void xiaoShou(HttpServletRequest req, HttpServletResponse resp) {
		...
		double xiaoshou = 0.0;// 销售额
		double lirun = 0.0;// 利润
		double shouru = 0.0;// 收入：0，支出：0
		double zhichu = 0.0;
		...
		list.clear();
		double cash = 0.0;// 现金支付金额
		double bank = 0.0;// 银联卡支付金额
		double online = 0.0;// 网银支付金额
		...
		list.clear();
		double vipCash = 0.0;// 会员卡现金充值总额
		double vipBank = 0.0;// 会员银行卡充值
		double vipOnline = 0.0;// 会员卡网银
	...
	private class Struct {
		public int sid = -1;// 店铺id
		public String start = "";// 开始日期，毫秒数
		public String end = "";// 结束日期，毫秒数

		public Struct(HttpServletRequest req) {
			String tempId = req.getParameter("store");
			String tempStart = req.getParameter("start");// readonly无需验证
