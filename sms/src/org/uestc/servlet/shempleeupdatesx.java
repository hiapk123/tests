...
@WebServlet(urlPatterns = "/shempleeupdatesx", name = "shempleeupdatesxServlet")
public class shempleeupdatesx extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sldql = "update employee set emp_status=" + shempeidtqiy + "," + " store_id=" + ssid + " ,emp_no=" + "'"
				+ shsecondbh + "'" + ", emp_name=" + "'" + shsecondxm + "'" + ", emp_tel=" + "'" + shsecondtel + "'"
				+ "where emp_id=" + shkkis;
