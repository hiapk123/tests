...
public class shloginit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 连表查询所需要的数据
		String longlist2 = "select start_time,end_time,emp_no,emp_name,total,total_all,total_money,bank_pay from employee a left join jiaojieban b on a.emp_id=b.saler_id where a.store_id="
				+ memdtoreid + " and start_time>=" + "'" + timestart + "'" + " and end_time<=" + "'" + timeend + "'"
				+ "limit " + current + ",10";
		List<Object[]> longlist3 = new MemInformServiceImp().normalfinad(longlist2);

		String longlist7 = "select start_time,end_time,emp_no,emp_name,total,total_all,total_money,bank_pay from employee a left join jiaojieban b on a.emp_id=b.saler_id where a.store_id="
				+ memdtoreid + " and start_time>=" + "'" + timestart + "'" + " and end_time<=" + "'" + timeend + "'";
