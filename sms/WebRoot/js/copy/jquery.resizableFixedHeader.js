...
(function($, window) {
  var ResizableFixedHeader;

  ResizableFixedHeader = (function () {
     ResizableFixedHeader.prototype.defaults = {
      store: window.store,
      rigidSizing: false,
      resizable: true,
      fixedHeader: true,
    ...
    function ResizableFixedHeader($table, options) {
      ...
      this.syncHandleWidthsAndFixedHeader();

      $(window).on('resize.rc', (function() {
        return _this.syncHandleWidthsAndFixedHeader();
      }));
    }

    ResizableFixedHeader.prototype.update = function () {
        this.restoreColumnWidths();
        this.syncHandleWidthsAndFixedHeader();
    };

    ResizableFixedHeader.prototype.destroy = function () {
        this.$handleContainer.remove();
        this.$fixedHeaderContainer.remove();
        this.$table.removeData('resizableColumns');
        return $(window).off('.rc');
    };

    ResizableFixedHeader.prototype.createFixedHeader = function () {
        var _this = this;

        var top = 0;
        if (this.$fixedHeaderContainer != undefined) {
            //top = $(".rc-fixedHeader-container").css("top");
            this.$fixedHeaderContainer.remove();
        }

        this.$table.before((this.$fixedHeaderContainer = $("<div class='rc-fixedHeader-container' style='width:100%;' />").css("top", top)));
        var $fixedTable = this.$table.clone().removeClass("resizableFixedHeader").removeAttr("id").empty().appendTo(_this.$fixedHeaderContainer);
        this.$table.find('thead').clone(true).appendTo($fixedTable);
    }

    ResizableFixedHeader.prototype.createHandles = function () {
      var _this = this;
    ...
    ResizableFixedHeader.prototype.syncHandleWidthsAndFixedHeader = function () {
        var _this = this;

        _this.createFixedHeader();
        /*
    ...
    ResizableFixedHeader.prototype.saveColumnWidths = function () {
      var _this = this;
    ...
    ResizableFixedHeader.prototype.restoreColumnWidths = function () {
      var _this = this;
    ...
    ResizableFixedHeader.prototype.mousedown = function (e) {
      var $currentGrip, $leftColumn, $rightColumn, idx, leftColumnStartWidth, rightColumnStartWidth, tableWidth,
        _this = this;
      ...
      $(document).on('mousemove.rc', function (e) {
         var difference, newLeftColumnWidth, newRightColumnWidth, newTableWidth;
        ...
        _this.$table.width(newTableWidth);
      ...
      return $(document).one('mouseup', function() {
          ...
          _this.options.resized.call(_this);
          return _this.saveColumnWidths();
      });
    };

    return ResizableFixedHeader;
     ...
     resizableFixedHeader: function () {
      ...
      return this.each(function() {
        ...
        if (data) {
            ...
            $table.data('resizableColumns', (data = new ResizableFixedHeader($table, option)));
        }
