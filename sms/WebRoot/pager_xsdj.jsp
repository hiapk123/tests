...
<script type="text/javascript">
	function _go() {
		...
		location = "${pb.url}&pc="+pc+"&hp_store=${storeName}&receiptType=${receiptType}&beginTime=${beginTime}&endTime=${endTime}&seriNum=${seriNum}";
	}
</script>
...
<div class="divBody">
	<div class="divContent">
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="${pb.url }&pc=${pb.pc-1}&hp_store=${storeName}&receiptType=${receiptType}&beginTime=${beginTime}&endTime=${endTime}&seriNum=${seriNum}" class="aBtn bold">上一页</a>
			</c:otherwise>
		</c:choose>
		...
		<c:forEach begin="${begin }" end="${end }" var="i">
			<c:choose>
				...
				<c:otherwise>
					<a href="${pb.url }&pc=${i}&hp_store=${storeName}&receiptType=${receiptType}&beginTime=${beginTime}&endTime=${endTime}&seriNum=${seriNum}" class="aBtn">${i }</a>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="${pb.url }&pc=${pb.pc+1}&hp_store=${storeName}&receiptType=${receiptType}&beginTime=${beginTime}&endTime=${endTime}&seriNum=${seriNum}" class="aBtn bold">下一页</a>
