						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="g_barcode"
									value="<%=good[3]%>" placeholder="请输入名称">
							</div>
							<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="radio">
									...
									<input type="text" class="form-control" id="g_vip_price"
...
<form class="form-horizontal" role="form">
					...
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="g_cl_min" value="<%=good[23]%>" class="form-control" >
							</div>
							<div class="form-group">
					...
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="g_stock_nor" class="form-control" value="<%=good[24]%>">
							</div>
							<div class="col-sm-1"></div>
							<div class="col-sm-3">
			...
			<div class="form-horizontal" role="form">
						<div class="form-group">
							<div class="col-sm-9">
								<input type="text" id="g_info" value="<%=good[28]%>" class="form-control"
									style="height: 300px">
							</div>
						</div>
					</div>
