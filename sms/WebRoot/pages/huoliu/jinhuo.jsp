...
{    var num=$("#11").find("table").length;
     if(num==0){
    	 alert("你还没有选择货物，请点击搜索然后双击商品来添加要进货的商品！");
    	 return;
     }
     $("#dakai").click();
...
<div id="dr">
	...
	<button type="button" class="btn btn-success btn-lg" 
			onclick="querenjinhuo()" >确认进货</button>	
			<button id="dakai" data-toggle="modal" data-target="#myModaljh"></button>
      </div>
   </div>
   ...
   <div class="modal-dialog">
	...
	{ 
       ...
       $.ajaxFileUpload({
                 ...
                 url:'<%=basePath%>huoliu?m=shangchuan1&s_id='+s_id+"&s_name="+s_name,             //需要链接到服务器地址
                 secureuri:false,
