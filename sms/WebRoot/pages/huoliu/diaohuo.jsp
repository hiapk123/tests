...
<button type="button" class="btn btn-success" style="width:150px" name="submit"
			>通知收银端入库</button> 
<button type="button" class="btn btn-warning" style="width:150px"  name="submit"
  onclick="zhijieruku()">直接入库</button>
...
<div id="Layer1" >
     <div  style="margin:200px auto;">
		<label>请选择调货门店</label> <select id="store_out"
	...
	<label>请选择进货门店</label>	<select id="store_in"
			class="singleSelector btn btn-block btn-success">
			<!-- <option value="-1" selected="selected" disabled="disabled">选择店铺</option> -->
			<%
