...
//	alert(discount);
   ...
   var hstart_time="";
	...
	$.post('<%=basePath%>DzytjServlet',{"subType":"tanchuceng","tc_type":"saveGoods","g_ids":s,
	...
	function addgoods(type){
		...
		//获得商品分类列表
		$.post('<%=basePath%>DzytjServlet',{"subType":"tanchuceng","tc_type":"getSelect"},function(data){	
	...
	function backlist(){
		...
		$.post('<%=basePath%>marketing?type=dzytj',
